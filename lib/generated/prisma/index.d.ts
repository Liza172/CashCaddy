...
export const ReccuringInterval: {
  DAILY: 'DAILY',
  WEEKLY: 'WEEKLY',
  MONTHLY: 'MONTHLY',
  YEARLY: 'YEARLY'
...
export type ReccuringInterval = (typeof ReccuringInterval)[keyof typeof ReccuringInterval]
...
export type ReccuringInterval = $Enums.ReccuringInterval

export const ReccuringInterval: typeof $Enums.ReccuringInterval
...
export namespace Prisma {
  ...
  */
  ...
  interface TransactionFieldRefs {
    ...
    readonly isReccuring: FieldRef<"Transaction", 'Boolean'>
    readonly reccuringInterval: FieldRef<"Transaction", 'ReccuringInterval'>
  ...
  /**
   * Reference to a field of type 'ReccuringInterval'
   */
  export type EnumReccuringIntervalFieldRefInput<$PrismaModel> = FieldRefInputType<$PrismaModel, 'ReccuringInterval'>
   ...
   * Reference to a field of type 'ReccuringInterval[]'
   */
  export type ListEnumReccuringIntervalFieldRefInput<$PrismaModel> = FieldRefInputType<$PrismaModel, 'ReccuringInterval[]'>
